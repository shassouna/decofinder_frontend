                            ...
                            <div className="col-lg-12">
                                <div className="row">
                                    <div className="col-lg-6 mb-6">
                                        <h5 className="mb-20">Le salon en ligne de la décoration et de l’ameublement depuis 1994 !</h5>
                                        <br/>
                                        ...
                                        <br/>
                                        <h6>Avec Decofinder tout est possible :</h6>
                                        <br/>
                                        <p>Grâce à l’une des offres les plus complètes sur le marché de la décoration et de l’ameublement, nous pouvons répondre à la majorité de vos demandes et de vos envies. Fausse poutre, encoignure ou encore chintz, notre équipe met tout en œuvre pour vous satisfaire.</p>
                                        <br/>
                                        <p>Vous cherchez un billot de cuisine, un bout de canapé ou bien une entrée de meuble pour vos serrures ? Nous avons les produits qu’il vous faut et surtout un vaste choix de couleurs, de formes et de matières, grâce à nos milliers d’exposants. Vasque de jardin, suspension multiple, table de jeux ou encore porte tasses, nous avons ce que vous cherchez !</p>
                                    </div>
                                    <div className="col-lg-6 mb-6">
                                        <p>Finalement, de l’intérieur à l’extérieur, de la table à la cuisine et à la salle de bain, du high-tech à la décoration, au linge de maison ou encore au monde de l’enfant, notre équipe reste présente et à l’affût pour vous proposer les meilleurs produits.</p>
                                        <br/>
                                        <h6>Un espace dédié pour les créateurs et les exposants :</h6>
                                        <br/>
                                        <p>Fort d’un savoir-faire dans l’univers du commerce en ligne, Decofinder s’est donné comme mission de valoriser les entreprises et les designers en leur offrant une plus large visibilité. Grâce à un descriptif d’entreprise, des fiches techniques détaillées et une mise en avant des sites Internet, toutes les conditions sont réunies pour assurer une notoriété croissante.</p>
                                        <br/>
                                        <p>Grâce à notre site internet proposé en 5 langues (francais, anglais, allemand, italien et espagnol) et nos millions de visiteurs annuels, vous serez mis en relation avec de nombreux futurs acheteurs.</p>
                                        <br/>
                                        <h6>Decofinder c'est aussi des idées et des conseils tendances pour votre intérieur et votre extérieur en matière de décoration et d’ameublement :</h6>
                                        <br/>
                                        <p>Quelquefois, il peut être compliqué de se projeter et de choisir un produit. C’est pourquoi, nous vous accompagnons également à travers notre Mag, dans la découverte des dernières tendances en matière de décoration, d’ameublement et de design, grâce à de nombreuses sélections. Nous vous présentons aussi les dernières créations élaborées par des designers ainsi que de nombreuses rénovations et créations architecturales, afin que jamais vous ne manquiez d’inspiration.</p>
                                        <br/>
                                        <p>Decofinder s’attache également à vous accompagner lors de l’aménagement et de l’optimisation de vos espaces ainsi que dans la réalisation de vos petits travaux, grâce à sa page Conseil. Retrouvez-y des astuces, des tutos et des recommandations pour donner vie à vos projets et pour plus d’inspiration, nous vous proposons des posts quotidiens sur nos réseaux sociaux.</p>
                                        <br/>
